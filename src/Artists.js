...
class Artists extends React.Component{
    ...
    //display current playing song artist details like poster name 
    render(){
        return(
            <div style={styles.artistsContainer}>
                ...
                <div style={styles.info}>
                    ...
                    <div style={styles.subInfo}>
                        <h4 style={{ marginBottom: '0.5rem' }}>IPod.js <span><img style={styles.image} alt="Ipod icon" src="https://cdn-icons-png.flaticon.com/128/447/447591.png" /></span></h4>
                        <p style={{marginBottom:'0'}}> React Project</p>
                        <p>Made by : Jay Zadafiya</p>
                    </div>
