...
class Ipod extends React.Component{
    ...
    //by using ZingTouch module perfom wheel rotatin event and select menu time
    rotateWheel = () => {
    ...
    // fuction for state change bas on click event
    changePage = () => {
    ...
    //use for toggling play and pause button 
    toggle = () =>{
                ...
                <div id='inner-container' style = {styles.wheel} onMouseOver={this.rotateWheel}>
                    ...
                    <div style = {styles.buttonContainer}>
                        <div onClick={this.toggle} style = {styles.playButton}>
                            {!this.state.play ? <i onClick={this.toggle} style = {styles.image} className="fas fa-play"></i>:<i onClick={this.toggle} style={styles.image} className="fas fa-pause"></i>}
                            &nbsp;
                        </div>
                    </div>
                </div>
