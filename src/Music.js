            ...
            <div style={styles.musicScreen} id='music-screen'>
                <div style={styles.menuList} id='menu-list'>
                    <div style={styles.titleBar}>
                        ...
                        <img style={styles.battery} alt="battry" src="https://cdn-icons-png.flaticon.com/128/664/664883.png"></img>
                    </div>

                    {/* display left side pannal with music and artist by click oon them i will show and start music */}
